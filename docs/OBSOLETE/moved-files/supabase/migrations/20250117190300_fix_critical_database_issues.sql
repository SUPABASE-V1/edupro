...
CREATE TABLE IF NOT EXISTS public.push_notifications (
    ...
    notification_type text DEFAULT 'general' CHECK (notification_type IN ('general', 'homework', 'announcement', 'payment', 'emergency', 'reminder')),
...
CREATE INDEX IF NOT EXISTS idx_child_reg_requests_preschool_status ON public.child_registration_requests(preschool_id, status);
