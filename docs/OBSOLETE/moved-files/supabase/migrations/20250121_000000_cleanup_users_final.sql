...
-- Direct cleanup
DELETE FROM profiles WHERE email = 'admin@youngeagles.org.za';
DELETE FROM profiles WHERE email = 'king@youngeagles.org.za';
...
WHERE school_id = (SELECT id FROM preschools WHERE name ILIKE '%young eagles%' LIMIT 1);
...
UNION ALL
SELECT 'Schools:', COUNT(*) FROM preschools
UNION ALL
